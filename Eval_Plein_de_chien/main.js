...
class Figure {
  constructor(params) {
    ...
    for (let i = 0; i < nbr_of_dog; i++) {
      // spawn aléatoire + nbr de chien
      this.group.position.x = Math.random()*10;
      this.group.position.y = Math.random()*10;
...
const jump = () => {
  ...
  jumpTimeline
    ...
    .to(
      ...
      0,
    ) // démarre en même temps que le premier .to()
    .to(figure.params, {
      y: -1.5,
      armRotation: 0,
      duration: 0.5,
